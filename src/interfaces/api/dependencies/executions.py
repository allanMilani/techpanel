...
from src.interfaces.api.dependencies.runners import get_runner_registry, get_notification_service
...
def get_run_next_step_use_case(
    execution_repo: Annotated[IExecutionRepository, Depends(get_execution_repository)],
    step_execution_repo: Annotated[IStepExecutionRepository, Depends(get_step_execution_repository)],
    pipeline_repo: Annotated[IPipelineRepository, Depends(get_pipeline_repository)],
